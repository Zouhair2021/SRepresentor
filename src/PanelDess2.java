...
public class PanelDess2 extends JPanel
{
    ...
    public PanelDess2(SRepresentor frame)
    {
        couleurBlocs = SRepresentor.couleurBlocs;
        setPreferredSize(new Dimension(frame.getWidth()-30, frame.getHeight()/2-(SRepresentor.HAUT_PAN_CORRECTION+5)));
